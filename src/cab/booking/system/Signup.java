...
public class Signup extends JFrame implements ActionListener, SignupActions {
	...
	public void actionPerformed(ActionEvent ae) {
		try {
			...
			if (ae.getSource() == b1) {
				...
				String sql = "insert into account values('" + username + "', '" + name + "', '" + password + "', '" + question
						+ "', '" + answer + "')";
	...
	@Override
	public void logSignupAttempt(String username) {
		System.out.println("User signup attempted: " + username + " at " + java.time.LocalDateTime.now());
	}

	@Override
	public void validateUserData(String data) {
		if(data.length() < 6) {
			System.out.println("Warning: Password length less than 6 characters");
		} else {
